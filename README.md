...
Note: to maximize time you save by using this package,
it is recommended to keep all your packages in a single project with Package Constructor installed and configured.
...
<br />Read more in [Unity Manual](https://docs.unity3d.com/Manual/upm-manifestPkg.html)
...
- `License` – Identifier for an OSS license using the [SPDX identifier format](https://spdx.org/licenses),
or a string such as `See LICENSE.md file`.
<br /><br />
...
Generates a blank `.cs` script alongside each `.asmdef` file.
